...
public interface PatientDataGenerator {
    ...
    /**
     * Generates health data for a specified patient and outputs it through a output strategy.
     * 
     * @param patientId a unique identifier for particular patient for whom data is generated given as an integer
     * @param outputStrategy is the strategy used to output the health data
     */
